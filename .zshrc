...
alias n=nvim
alias nv=nvim
alias ig="open -a Instagram"
alias wa="open -a Whatsapp"


function lc(){
  clear
  echo "you got cl command wrong, lol"
}
...
function mc()
{
  if [ $1 = "on" ]; then
    open -a TL\ Legacy
    shortcuts run "RAM Clean Mode"
    sleep 18
    osascript -e 'tell application "System Events" to tell process "TL" to set frontmost to true'
    sleep 1
    osascript -e 'tell application "System Events" to tell process "TL" to set frontmost to true'
    cliclick c:844,650
  elif [ $1 = "off" ]; then
